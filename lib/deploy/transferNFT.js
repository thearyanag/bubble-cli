const { Keypair, PublicKey, Connection , TransactionMessage , VersionedTransaction } = require("@solana/web3.js");
...
async function transferNFT(newOwner) {
  ...
  console.log(`See the transaction here: https://solscan.io/tx/${sx}?cluster=${constants.getCluster()}`);
}
